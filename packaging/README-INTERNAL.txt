...
卸载
双击“卸载 LK‘s File Bridge.command”。它会把扩展目录移到废纸篓，不会删除 NAS 素材、Adobe 工程或本机收藏状态。

反馈
请记录：Adobe 软件及版本、macOS 版本、素材格式、是否为 SMB 路径、复现步骤和面板提示文字。不要把账号密码、NAS 凭据或源素材发到群里。
